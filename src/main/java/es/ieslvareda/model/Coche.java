...
public class Coche extends Vehiculo{
    ...
    public Coche(String matricula, float precioHora, String marca, String descripcion, String color, float bateria, String estado, float idCarnet, Date date, Tablas tablas, float numPlazas, float numPuertas) {
