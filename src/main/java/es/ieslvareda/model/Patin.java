...
public class Patin extends Vehiculo{
    ...
    public Patin(String matricula, float precioHora, String marca, String descripcion, String color, float bateria, String estado, String idCarnet, Date date, Tablas tablas, float numRuedas, float tamanyo) {
